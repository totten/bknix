...
let
    ...
    phpOverride = stdenv.mkDerivation rec {
        name = "bknix-php70";
        buildInputs = [phpRuntime phpPkgs.xdebug phpPkgs.redis phpPkgs.yaml phpPkgs.memcached phpPkgs.imagick phpExtras.timecop phpExtras.runkit7_1 pkgs.makeWrapper];
        buildCommand = ''
